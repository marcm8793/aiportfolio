...
export const metadata: Metadata = {
  title: "About Me",
  description: "Learn more about Marc Mansour and his work.",
};
  ...
  return (
    <section className="space-y-6">
      ...
      <section className="space-y-3">
        <H2>Who am I?</H2>
        <p>
          My name is Marc Mansour and I am a self-taught software developer from
          France. I started programming in 2017, at the age of 26, and since
          then I have created hundreds of tutorials on my YouTube channel{" "}
          <a
